var e = {
        4567: (e, t, i) => {
            ...
            class a extends o.Disposable {
                constructor(e) {
                    if (
                        ...
                        (this._liveRegionDebouncer = this.register(
                            new n.TimeBasedDebouncer(this._announceCharacters.bind(this))
                        )),
                    ...
                    this._terminal.element.insertAdjacentElement(
                        ...
                        this.register(
                            (0, o.toDisposable)(() => this._accessibilityContainer.remove())
                        );
                }
                _handleTab(e) {
                    ...
                    this._liveRegionLineCount < 21 &&
                        ...
                        '\n' === e &&
                            ...
                            21 === this._liveRegionLineCount &&
                                (this._liveRegion.textContent += s.tooMuchOutput)),
                        r.isMac &&
                ...
                _clearLiveRegion() {
                    (this._liveRegion.textContent = ''),
                        (this._liveRegionLineCount = 0),
                        r.isMac && this._liveRegion.remove();
                }
                _handleKey(e) {
            ...
            let c = class extends a.Disposable {
                ...
                attachToDom(e, t, i) {
                    (this._element = e),
                        ...
                        this.register(
                            (0, h.addDisposableDomListener)(this._element, 'mouseleave', () => {
                ...
                _handleNewLink(e) {
                    ...
                    t &&
                        ...
                        (this._currentLink.state = {
                            decorations: {
                                underline:
                                    void 0 === e.link.decorations || e.link.decorations.underline,
                                pointerCursor:
            ...
            class I extends w.CoreTerminal {
                constructor(e = {}) {
                    super(e),
                        ...
                        this.register(
                            (0, v.forwardEvent)(this._inputHandler.onCursorMove, this._onCursorMove)
                        ),
                        this.register(
                            (0, v.forwardEvent)(
                ...
                _handleScreenReaderModeOptionChange(e) {
                    ...
                    e
                        ...
                        : (null === (t = this._accessibilityManager) || void 0 === t || t.dispose(),
                ...
                _initGlobal() {
                    ...
                    this.register((0, l.addDisposableDomListener)(this.textarea, 'paste', e)),
                        this.register((0, l.addDisposableDomListener)(this.element, 'paste', e)),
                        c.isFirefox
                            ? this.register(
                                  (0, l.addDisposableDomListener)(this.element, 'mousedown', e => {
                                      2 === e.button &&
                        ...
                        c.isLinux &&
                            this.register(
                                (0, l.addDisposableDomListener)(this.element, 'auxclick', e => {
                                    1 === e.button &&
                ...
                _bindKeys() {
                    this.register(
                        ...
                        this.register(
                            (0, l.addDisposableDomListener)(this.textarea, 'compositionstart', () =>
                                this._compositionHelper.compositionstart()
                            )
                        ),
                        this.register(
                            (0, l.addDisposableDomListener)(this.textarea, 'compositionupdate', e =>
                                this._compositionHelper.compositionupdate(e)
                            )
                        ),
                        this.register(
                            (0, l.addDisposableDomListener)(this.textarea, 'compositionend', () =>
                ...
                open(e) {
                    ...
                    this._renderService.hasRenderer() ||
                        ...
                        this.register(
                            (0, l.addDisposableDomListener)(this._viewportElement, 'scroll', () =>
                        ...
                        switch (t.overrideType || t.type) {
                            case 'mousemove':
                                (r = 32),
                                    void 0 === t.buttons
                                        ? ((s = 3),
                                          void 0 !== t.button && (s = t.button < 3 ? t.button : 3))
                                        : (s =
                                              1 & t.buttons
                                                  ? 0
                                                  : 4 & t.buttons
                    ...
                    if (this._renderService)
                        switch (e) {
                            case a.WindowsOptionsReportType.GET_WIN_SIZE_PIXELS:
                                const e =
                                        this._renderService.dimensions.css.canvas.width.toFixed(0),
            ...
            let c = class extends n.Disposable {
                ...
                _smoothScroll() {
                    ...
                    (this._viewportElement.scrollTop =
                        ...
                        Math.round(
                            e * (this._smoothScrollState.target - this._smoothScrollState.origin)
                        )),
                        e < 1
                            ? this._coreBrowserService.window.requestAnimationFrame(() =>
                                  this._smoothScroll()
                ...
                getBufferElements(e, t) {
                    ...
                    for (let t = e; t < o; t++) {
                        ...
                        if (!e) continue;
                        const o =
                            null === (i = a.get(t + 1)) || void 0 === i ? void 0 : i.isWrapped;
                ...
                handleTouchMove(e) {
                    ...
                    return (
                        (this._lastTouchY = e.touches[0].pageY),
                        0 !== t &&
                            ((this._viewportElement.scrollTop += t), this._bubbleScroll(e, t))
                    );
                }
            };
            (c = s(
                ...
                _createElement(e) {
                    ...
                    i.classList.add('xterm-decoration'),
                        (i.style.width = `${Math.round(
                            (e.options.width || 1) * this._renderService.dimensions.css.cell.width
                        )}px`),
                        (i.style.height =
                            (e.options.height || 1) *
        ...
        1296: function (e, t, i) {
            ...
            const n = i(3787),
                ...
                S = 'xterm-selection';
            let m = 1,
                C = class extends d.Disposable {
                    constructor(e, t, i, s, r, o, h, c, _, v) {
                        super(),
                            (this._element = e),
                            (this._screenElement = t),
                            ...
                            this.register(v.onChangeColors(e => this._injectCss(e))),
                    ...
                    _updateDimensions() {
                        ...
                        const t = `${this._terminalSelector} .${f} span { display: inline-block; height: 100%; vertical-align: top; width: ${this.dimensions.css.cell.width}px}`;
                    ...
                    _injectCss(e) {
                        ...
                        let t = `${this._terminalSelector} .${f} { color: ${e.foreground.css}; font-family: ${this._optionsService.rawOptions.fontFamily}; font-size: ${this._optionsService.rawOptions.fontSize}px;}`;
                        (t += `${this._terminalSelector} span:not(.${n.BOLD_CLASS}) { font-weight: ${this._optionsService.rawOptions.fontWeight};}${this._terminalSelector} span.${n.BOLD_CLASS} { font-weight: ${this._optionsService.rawOptions.fontWeightBold};}${this._terminalSelector} span.${n.ITALIC_CLASS} { font-style: italic;}`),
                            ...
                            (t +=
                                ...
                                `  color: ${e.cursor.css}; }}`),
                            (t +=
                                `${this._terminalSelector} .${f}:not(.${p}) .${n.CURSOR_CLASS}.${n.CURSOR_STYLE_BLOCK_CLASS} { outline: 1px solid ${e.cursor.css}; outline-offset: -1px;}${this._terminalSelector} .${f}.${p} .${n.CURSOR_CLASS}.${n.CURSOR_BLINK_CLASS}:not(.${n.CURSOR_STYLE_BLOCK_CLASS}) { animation: blink_box_shadow_` +
                                this._terminalClass +
                                ' 1s step-end infinite;}' +
                                `${this._terminalSelector} .${f}.${p} .${n.CURSOR_CLASS}.${n.CURSOR_BLINK_CLASS}.${n.CURSOR_STYLE_BLOCK_CLASS} { animation: blink_block_` +
                                this._terminalClass +
                                ' 1s step-end infinite;}' +
                                `${this._terminalSelector} .${f}.${p} .${n.CURSOR_CLASS}.${n.CURSOR_STYLE_BLOCK_CLASS} {` +
                                ` background-color: ${e.cursor.css};` +
                                ` color: ${e.cursorAccent.css};}` +
                                `${this._terminalSelector} .${f} .${n.CURSOR_CLASS}.${n.CURSOR_STYLE_BAR_CLASS} {` +
                                ` box-shadow: ${this._optionsService.rawOptions.cursorWidth}px 0 0 ${e.cursor.css} inset;}` +
                                `${this._terminalSelector} .${f} .${n.CURSOR_CLASS}.${n.CURSOR_STYLE_UNDERLINE_CLASS} {` +
                        ...
                        for (const [i, s] of e.ansi.entries())
                            t += `${this._terminalSelector} .${v}${i} { color: ${s.css}; }${this._terminalSelector} .${g}${i} { background-color: ${s.css}; }`;
                        (t += `${this._terminalSelector} .${v}${
                            o.INVERTED_DEFAULT_COLOR
                        } { color: ${c.color.opaque(e.background).css}; }${
                            this._terminalSelector
                        } .${g}${o.INVERTED_DEFAULT_COLOR} { background-color: ${
                            e.foreground.css
                        }; }`),
                    ...
                    renderRows(e, t) {
                        ...
                        for (let n = e; n <= t; n++) {
                            ...
                            (this._cellToRowElements[n] &&
                                this._cellToRowElements[n].length === this._bufferService.cols) ||
            ...
            let f = class {
                ...
                createRow(e, i, s, r, a, h, l, _, f) {
                    ...
                    for (let t = Math.min(e.length, _) - 1; t >= 0; t--)
                        if (
                            e.loadCell(t, this._workCell).getCode() !== o.NULL_CELL_CODE ||
                            (s && t === a)
                        ) {
                            S = t + 1;
                            break;
                    ...
                    for (; b < S; b++) {
                        ...
                        if (
                            ...
                            S && ((E.style.display = 'inline'), a >= b && a <= y && (a = b)),
                        ...
                        switch ((x || (w.isDim() && (x = c.color.multiplyOpacity(O, 0.5))), k)) {
                            ...
                            case 33554432:
                                w.isBold() &&
                                    ...
                                    this._optionsService.rawOptions.drawBoldTextInBrightColors &&
                                    (L += 8),
                                    this._applyMinimumContrast(E, O, m.ansi[L], w, x, void 0) ||
                            ...
                            case 50331648:
                                ...
                                break;
                            default:
                                this._applyMinimumContrast(E, O, m.foreground, w, x, void 0) ||
                                    (A && E.classList.add(`xterm-fg-${n.INVERTED_DEFAULT_COLOR}`));
                        }
                ...
                _applyMinimumContrast(e, t, i, s, r, n) {
                    ...
                    return (
                        r ||
                            n ||
                            (o = this._themeService.colors.contrastCache.getColor(t.rgba, i.rgba)),
                        void 0 === o &&
            ...
            let u = class extends a.Disposable {
                constructor(e, t, i, s, r, a, l, d) {
                    if (
                        ...
                        (this._renderDebouncer = new n.RenderDebouncer(l.window, (e, t) =>
                ...
                handleResize(e, t) {
                    this._renderer &&
                        (this._isPaused
                            ? this._pausedResizeTask.set(() => this._renderer.handleResize(e, t))
        ...
        9312: function (e, t, i) {
            ...
            let p = class extends u.Disposable {
                ...
                _selectWordAtCursor(e, t) {
                    ...
                    return (
                        !!n && (this._selectWordAt(n, t), (this._model.selectionEnd = void 0), !0)
                    );
                }
                selectAll() {
                ...
                (function (e) {
                    ...
                    (e.blend = function (e, t) {
                        ...
                        (e.opaque = function (e) {
                            ...
                            return (
                                ([r, n, o] = l.toChannels(t)), { css: h.toCss(r, n, o), rgba: t }
                            );
                        }),
                        (e.opacity = t),
            ...
            class m extends s.Disposable {
                constructor(e) {
                    super(),
                        ...
                        this.register(
                            (0, l.forwardEvent)(this._inputHandler.onLineFeed, this._onLineFeed)
                        ),
                        this.register(this._inputHandler),
                        this.register(
                            (0, l.forwardEvent)(this._bufferService.onResize, this._onResize)
                        ),
                        ...
                        this.register(
                            this.optionsService.onSpecificOptionChange('windowsMode', e =>
                                this._handleWindowsModeOptionChange(e)
                            )
                        ),
                        this.register(
                        ...
                        this.register(
                            (0, s.toDisposable)(() => {
                                var e;
                                null === (e = this._windowsMode) || void 0 === e || e.dispose(),
                ...
                _enableWindowsMode() {
                    if (!this._windowsMode) {
                        ...
                        e.push(
                            this.onLineFeed(
                                f.updateWindowsModeWrappedState.bind(null, this._bufferService)
                            )
                        ),
                            e.push(
                                this.registerCsiHandler(
                                    { final: 'H' },
                                    () => (
                                        (0, f.updateWindowsModeWrappedState)(this._bufferService),
                                        !1
                                    )
                                )
                            ),
            ...
            class E extends h.Disposable {
                ...
                parse(e, t) {
                    ...
                    if (
                        ...
                        if ((i = this._parser.parse(this._parseBuffer, t)))
                            return (
                                this._preserveStack(s, r, t, 0), this._logSlowResolvingAsync(i), i
                            );
                    }
                    ...
                    for (let r = 0; r < t; r++)
                        (i = e.params[r]),
                            i >= 30 && i <= 37
                                ...
                                ? (s.fg &= 2147483647)
                                : 39 === i
                                ? ((s.fg &= -67108864), (s.fg |= 16777215 & l.DEFAULT_ATTR_DATA.fg))
                                : 49 === i
                                ? ((s.bg &= -67108864), (s.bg |= 16777215 & l.DEFAULT_ATTR_DATA.bg))
                                : 38 === i || 48 === i || 58 === i
                ...
                windowOptions(e) {
                    ...
                    switch (e.params[0]) {
                        case 14:
                            2 !== t &&
                                this._onRequestWindowsOptionsReport.fire(y.GET_WIN_SIZE_PIXELS);
                            break;
                        case 16:
            ...
            t.SortedList = class {
                ...
                insert(e) {
                    0 !== this._array.length
                        ? ((i = this._search(this._getKey(e), 0, this._array.length - 1)),
        ...
        3734: (e, t) => {
            ...
            class i {
                ...
                clone() {
                    const e = new i();
                    return (
                        (e.fg = this.fg), (e.bg = this.bg), (e.extended = this.extended.clone()), e
                    );
                }
                isInverse() {
                ...
                (t.Buffer = class {
                    ...
                    _reflowLargerAdjustViewport(e, t, i) {
                        ...
                        for (; n-- > 0; )
                            0 === this.ybase
                                ? (this.y > 0 && this.y--,
                                  this.lines.length < t && this.lines.push(new r.BufferLine(e, s)))
                    ...
                    _reflowSmaller(e, t) {
                        ...
                        for (let o = this.lines.length - 1; o >= 0; o--) {
                            ...
                            v.length > 0 &&
                                (s.push({ start: o + c.length + n, newLines: v }), (n += v.length)),
                                c.push(...v);
                            let g = _.length - 1,
                                p = _[g];
                            0 === p && (g--, (p = _[g]));
                            ...
                            for (; C-- > 0; )
                                0 === this.ybase
                                    ? this.y < t - 1
                                        ...
                                        : (this.ybase++, this.ydisp++)
                                    : this.ybase <
                                          Math.min(this.lines.maxLength, this.lines.length + n) -
                                              t &&
                ...
                (t.DcsHandler = class {
                    ...
                    unhook(e) {
                        ...
                        if (this._hitLimit) t = !1;
                            ...
                            return t.then(
                                e => (
                                    (this._params = a), (this._data = ''), (this._hitLimit = !1), e
                                )
                            );
                        ...
                        if (t.length !== n)
                            throw new Error(
                                `[createInstance] First service dependency of ${
                                    e.name
                                } at position ${n + 1} conflicts with ${t.length} static arguments`
                            );
                        return new e(...[...t, ...s]);
                    }
                });
...
(() => {
    var e = s;
    Object.defineProperty(e, 'X', { value: !0 }), (e.o = void 0);
    const t = i(3236),
        r = i(9042),
        n = i(7975),
        o = i(7090),
    ...
    e.o = class {
        ...
        get buffer() {
            return (
                this._buffer || (this._buffer = new h.BufferNamespaceApi(this._core)), this._buffer
            );
        }
        get markers() {
...
var r = s.o,
    n = s.X;
export { r as Terminal, n as __esModule };
